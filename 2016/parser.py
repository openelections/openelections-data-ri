...
for town in towns:
    url = "https://rigov.s3.amazonaws.com/election/results/2016/general_election/%s.json" % town.lower().replace(' ','_')
    r = requests.get(url)
...
with open("20161108__ri__general__county.csv", "wb") as csvfile:
